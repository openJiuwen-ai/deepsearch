...
1. [Directory structure](./directory_structure.md) for module boundaries and the main pipeline.
2. [openJiuwen DeepSearch Developer Guide](./openJiuwen%20DeepSearch%20Developer%20Guide/README.md) for integration patterns and examples.
3. [API Reference](./API%20Reference/agent_factory.md) for classes, nodes, configuration fields, and export interfaces.
