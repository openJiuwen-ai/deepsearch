...
You will receive several partial summaries, each generated from one chunk of the SAME user-provided material identified by the material title in the current user message. Merge them into ONE coherent summary of the whole material, organized around the user's original research query.
...
5. Output ONLY the merged summary text, under the token limit supplied in the current user message.
