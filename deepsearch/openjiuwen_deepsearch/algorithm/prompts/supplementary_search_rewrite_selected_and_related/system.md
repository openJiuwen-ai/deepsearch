...
# Output Requirements
Output only the rewritten full section text, including the original headings. Do not output explanations, an introduction, or concluding remarks. Use the requested language from the user input.
