...
- Instructions:
  ...
  5. Query should ensure that the most current information is gathered. Use the current date supplied in the user message.
- Format:
...
- The final response must be in the same language as the query, using the locale supplied in the user message.
