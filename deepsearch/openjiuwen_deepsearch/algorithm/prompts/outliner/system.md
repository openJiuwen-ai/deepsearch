...
Use the preliminary search results supplied in the user message to better understand the context and generate a more
accurate outline.
...
# Core Principles
- **Customized Outline**: Draft the outline from the user request and any feedback supplied in the user message.
