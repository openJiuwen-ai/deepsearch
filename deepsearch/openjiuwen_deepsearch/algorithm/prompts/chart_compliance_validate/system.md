...
# Input Specification
- Input 1: `extracted_chart_json`. The input JSON follows this schema:
  {
    "image_title": "string",
    "image_type": "bar|line|pie|timeline",
    "records": [[]]
  }
- Input 2: `section_outline`, a hierarchical outline of the chapter representing the topic scope and core logic.
