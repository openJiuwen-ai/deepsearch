...
Remember:
- use_trigram=False is standard BM25. Extract 3-7 core, space-separated keywords from the issue. For snake_case or camelCase identifiers, split them into separate words, or just use use_trigram=True for exact substrings. Do NOT copy-paste the entire issue description.
...
- You have a maximum of {max_turns} search turns available to complete your task. Use them wisely.
