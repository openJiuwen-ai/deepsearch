# openJiuwen-CodeSearch 文档

| 目录 | 内容 |
|---|---|
| [zh/1.产品简介](zh/1.产品简介/1.产品简介.md) | 产品定位、核心能力、系统架构 |
| [zh/2.安装指导](zh/2.安装指导/README.md) | 环境要求、安装步骤、Milvus 部署 |
| [zh/3.快速开始](zh/3.快速开始/3.快速开始.md) | CLI 与 Python API 上手 |
