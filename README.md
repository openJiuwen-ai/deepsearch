...
* 根据机器架构下载版本包：
  ...
  - 下载 x86_64 架构版本包
    ```
    wget https://openjiuwen-ci.obs.cn-north-4.myhuaweicloud.com/agentstudio/deployTool_0.1.4_amd64.zip
    ```

  - 下载 arm 架构版本包：
    ```
    wget https://openjiuwen-ci.obs.cn-north-4.myhuaweicloud.com/agentstudio/deployTool_0.1.4_arm64.zip
    ```
...
* 解压对应的架构版本包。
  - 解压 x86_64 架构版本包
    ```
    unzip deployTool_0.1.4_amd64.zip
    ```

  - 解压 arm 架构版本包
    ```
    unzip deployTool_0.1.4_arm64.zip
    ```

* 进入 *deployTool_0.1.4_xxx64* 目录，输入以下命令确认 Docker 已启动：
...
> 如需下载清晰版本，可点击下载[完整视频](https://openjiuwen-ci.obs.cn-north-4.myhuaweicloud.com/deepsearch/readme/9e6e857a424167500d4b4277485ea9b1_raw.mp4) <br>
